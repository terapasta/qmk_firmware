...
[_QWERTY] = LAYOUT(
    ...
    KL_TAB, KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,               KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_ENT,
    ...
    KC_LCTL,KC_LGUI,KC_LALT,KC_DEL, KA_EISU,KL_LSPC,            KS_RSPC,KL_KANA,KC_BSLS,KC_LEFT,KC_DOWN,KC_RGHT
),
[_LOWER] = LAYOUT(
