...
[_QWERTY] = LAYOUT(
    KC_0,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,   KC_Y,      KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,    KC_MINS, KC_6,
    KC_1,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,              KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN, KC_5,
    KC_2, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,              KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT,  KC_4,   KC_SLSH,
    KC_3, KC_4, KC_5,  KC_6, KC_7,                    KC_8,KC_9,KC_0,        KC_1, KC_2, KC_3
),
[_LOWER] = LAYOUT(
    KC_GRV,  cmd(KC_Q), cmd(KC_W), cmd(KC_E), cmd(KC_R), cmd(KC_T), cmd(KC_Y),  cmd(KC_Y), cmd(KC_U), cmd(KC_I), cmd(KC_O), cmd(KC_P), KC_EQL,_______,
    _______, cmd(KC_A), cmd(KC_S), cmd(KC_D), cmd(KC_F), cmd(KC_G),             cmd(KC_H), cmd(KC_J), cmd(KC_K), cmd(KC_L), KC_QUOT,   _______,
    _______, cmd(KC_Z), cmd(KC_X), cmd(KC_C), cmd(KC_V), cmd(KC_B),             cmd(KC_B), cmd(KC_N), cmd(KC_M), KC_LCBR,   KC_RCBR,   KC_PGUP, KC_BSLS,
    _______, _______,   _______,   _______,   _______,              _______,    _______,   KC_BSLS,                         KC_HOME,   KC_PGDN, KC_END
),
[_RAISE] = LAYOUT(
    _______,KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,       KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_EQL,  _______,
    _______,_______,_______,_______,_______,_______,            _______,_______,_______,_______,KC_QUOT,_______,
    _______,_______,_______,_______,_______,_______,            _______,_______,_______,KC_LBRC,KC_RBRC,KC_PGUP,KC_BSLS,
    _______,_______,_______,_______,_______,                    _______,_______,KC_BSLS,        KC_HOME,KC_PGDN,KC_END
),
[_FUNCS] =  LAYOUT(
