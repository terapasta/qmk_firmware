...
[_QWERTY] = LAYOUT(
    ...
    KC_LCTL,KC_LALT,KC_LGUI, KL_EISU,                KC_SPC, KS_KANA,MO(_RAISE),KC_RGUI,              KC_LEFT, KC_DOWN, KC_RGHT
),
[_LOWER] = LAYOUT(
...
[_RAISE] = LAYOUT(
    KC_TILD,s(KC_1),s(KC_2),s(KC_3),s(KC_4),s(KC_5),        s(KC_6),s(KC_7),s(KC_8),s(KC_9),s(KC_0),   s(KC_MINS),s(KC_EQL), s(KC_BSLS),s(KC_GRV),
