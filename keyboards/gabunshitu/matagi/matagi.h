...
#define LAYOUT( \
    ...
    { K_FN, K_MENU, K_WIN, K_LCTL,  /**/ xxxx, K_SPC, K_LT, K_DN,        /**/ K_RT, K_PGDN, L_RCTL, xxxx,    /**/ K_HOME, K_UP, K_END, K_PGUP },    \
    { K_F12, K_F11, K_F10, K_F9,    /**/ K_ALT, xxxx, xxxx, xxxx,      /**/ xxxx, xxxx, xxxx, xxxx,        /**/ xxxx, xxxx, xxxx, xxxx },     \
