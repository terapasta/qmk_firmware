...
[_QWERTY] = LAYOUT(
        KC_0,     KC_9,  KC_0,  KC_1,  KC_2,  KC_3,  KC_4,      KC_5,  KC_6,  KC_7,  KC_8,  KC_9,  KC_0, KC_1, KC_2,                            KC_1,KC_2,RGB_TOG,
        ...
        KC_5,   KC_6,KC_7,KC_8,KC_9,KC_0,                           KC_1,KC_2,                                                                  KC_7,KC_8,KC_9
),
[_LOWER] = LAYOUT(
        ...
        _______,   _______,_______,c(KC_DEL),_______,_______,               _______,_______,                                                                            _______,_______,_______
),
[_RAISE] = LAYOUT(
        ...
        _______,   _______,_______,o(KC_DEL),_______,_______,               _______,_______,                                                                            _______,_______,_______
)
};
