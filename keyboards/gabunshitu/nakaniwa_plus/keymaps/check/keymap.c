...
[_QWERTY] = LAYOUT(
        KC_0,     KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   RC_F3,      KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,KC_EQL, KC_O,        KC_P, KC_Q,
        KC_1,     KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,               KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_LBRC,KC_RBRC,KC_L,        KC_M, KC_N,
        KC_2,    KC_A,   KC_S,   KC_D,   KC_F,   KC_G,               KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT,KC_I,                 KC_J,KC_K,
        KC_3,    KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,       KC_FN2, KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_F,                        KC_G,  KC_H,
        KC_4,   KC_5,KC_6,KC_7,KC_8,KC_9,              KC_A,KC_B,                                                 KC_C,KC_D,KC_E,
