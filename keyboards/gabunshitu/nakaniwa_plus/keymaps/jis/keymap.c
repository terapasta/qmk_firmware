...
[_QWERTY] = LAYOUT(
        KC_ESC,     KC_NO,  KC_NO,  KC_F1,  KC_F2,  KC_F3,  KC_F4,      KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12,     KC_PSCR,KC_SLCK,KC_PAUS,
        KC_GRV,     KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,       KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   JP_MINS,JP_CIRC, JP_YEN,KC_BSPC,    KC_INS, KC_HOME,
        KC_TAB,     KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,               KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   JP_AT,  JP_RBRC,JP_LBRC,            KC_DEL, KC_END,
        KC_LCTL,    KC_A,   KC_S,   KC_D,   KC_F,   KC_G,               KC_H,   KC_J,   KC_K,   KC_L,   JP_SCLN,JP_COLN,KC_ENT,                     KC_PSCR,KC_PGUP,
        KC_LSFT,    KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,       KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,JP_BSLS,KC_RSFT,                    KC_UP,  KC_PGDN,
        KC_LCTRL,   KC_LALT,KC_LGUI,KC_DEL,KC_SPC,KL_EISU,                      KL_KANA,KC_SPC, KC_SPC, KC_SPC, KC_SPC, KC_SPC,             KC_LEFT,KC_DOWN,KC_RIGHT
),
[_LOWER] = LAYOUT(
