...
[_QWERTY] = LAYOUT(
    ...
    KL_TAB, KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   JP_AT,  KC_UP,
    KC_LSFT,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_ENT, KC_DEL,
    KC_LCTL,KC_LGUI,KC_DEL, KA_SPC, KA_SPC, KL_EISU,KS_KANA,KL_SPC, JP_SLSH,KC_LEFT,KC_DOWN,KC_RIGHT,
    ...
    KC_7,   KC_8,   KC_9,   JP_EQL,
    KC_4,   KC_5,   KC_6,   JP_ASTR,
    KC_1,   KC_2,   KC_3,   JP_PLUS,
    KL_TAB, KC_0,   JP_DOT, KC_ENT
),
[_LOWER] = LAYOUT(
    _______,cmd(KC_Q),  cmd(KC_W),  cmd(KC_E),  cmd(KC_R),  cmd(KC_T),  cmd(KC_Y),  cmd(KC_U),  cmd(KC_I),  cmd(KC_O),  cmd(KC_P),  JP_CIRC,   _______,
    _______,cmd(KC_A),  cmd(KC_S),  cmd(KC_D),  cmd(KC_F),  cmd(KC_G),  cmd(KC_H),  cmd(KC_J),  cmd(KC_K),  cmd(KC_L),  _______,    KC_PGUP,
    _______,cmd(KC_Z),  cmd(KC_X),  cmd(KC_C),  cmd(KC_V),  cmd(KC_B),  cmd(KC_N),  cmd(KC_M),  JP_SCLN,    JP_COLN,    _______,    _______,
    _______,_______,    _______,    _______,    _______,    _______,    _______,    _______,    JP_YEN,     KC_HOME,    KC_PGDN,    KC_END,
...
[_RAISE] = LAYOUT(
    ...
    _______,_______,_______,_______,_______,_______,_______,_______,JP_LBRC,JP_RBRC,_______,_______,
    _______,_______,_______,_______,_______,_______,_______,_______,JP_BSLS,KC_HOME,KC_PGDN,KC_END,
...
[_FUNCS] = LAYOUT(
    ...
    _______,_______,_______,JP_SLSH,
    _______,_______,_______,JP_MINS,
    _______,_______,_______,_______
)
};
