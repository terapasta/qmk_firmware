...
[_QWERTY] = LAYOUT(
    ...
    KC_LCTL,KC_LGUI,KC_DEL, KA_SPC, KL_EISU,KS_KANA,KL_SPC,KC_RALT,KC_LEFT,KC_DOWN,KC_RIGHT
),
[_LOWER] = LAYOUT(
    _______,cmd(KC_Q),  cmd(KC_W),  cmd(KC_E),  cmd(KC_R),  cmd(KC_T),  cmd(KC_Y),  cmd(KC_U),  cmd(KC_I),  cmd(KC_O),  cmd(KC_P),  KC_MINS,    KC_EQL,
    _______,cmd(KC_A),  cmd(KC_S),  cmd(KC_D),  cmd(KC_F),  cmd(KC_G),  cmd(KC_H),  cmd(KC_J),  cmd(KC_K),  cmd(KC_L),  KC_QUOT,    cmd(KC_ENT),
    _______,cmd(KC_Z),  cmd(KC_X),  cmd(KC_C),  cmd(KC_V),  cmd(KC_B),  cmd(KC_N),  cmd(KC_M),  KC_LPRN,    KC_RPRN,    KC_PGUP,    KC_BSLS,
