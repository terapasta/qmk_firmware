...
[_QWERTY] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_DEL,  KC_LALT, KL_EISU,         KL_KANA, KC_SPC,  KC_RSFT, KC_LEFT, KC_DOWN, KC_RGHT
),
...
[_RAISE] = LAYOUT(
    ...
    _______, sft(KC_A), sft(KC_S), sft(KC_D), sft(KC_F), sft(KC_G), sft(KC_H), sft(KC_J), sft(KC_K),    sft(KC_L),   KC_QUOT, KC_ENT,
    _______, sft(KC_Z), sft(KC_X), sft(KC_C), sft(KC_V), sft(KC_B), sft(KC_N), sft(KC_M), sft(KC_COMM), sft(KC_DOT), KC_PGUP, KC_SLSH ,
    _______, _______,   _______,   _______,   _______,                _______,   _______,   _______,    KC_HOME,     KC_PGDN, KC_END
),
