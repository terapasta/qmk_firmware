...
[_FUNCS] =  LAYOUT(
    ...
    _______,_______,_______,_______,_______,_______,_______,_______,RGB_VAI,RGB_VAD,_______,RGB_SAI,
    _______,_______,_______,_______,_______,        _______,_______,RGB_HUI,RGB_SAD,RGB_HUDh
)
};
