...
[_QWERTY] = LAYOUT(
    KC_1, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I,    KC_O,   KC_P,    KC_MINS, KC_J,
    KC_2, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K,    KC_L,   KC_LBRC, KC_RBRC, KC_I,
    KC_3, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_H,    KC_G,
    KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0,       KC_A,    KC_B,   KC_C,    KC_D,    KC_E
),
[_LOWER] = LAYOUT(
...
[_FUNCS] =  LAYOUT(
    ...
    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,RGB_VAI,RGB_SAI,RGB_VAD,
