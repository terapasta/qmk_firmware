...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        KC_NO,  KC_LALT,KC_LALT,KC_LGUI,KL_EISU,                KL_KANA,KC_SPC,                 KC_RGUI,KC_LEFT,KC_DOWN,KC_RIGHT
    ),
    [_LOWER] = LAYOUT(
        KC_1,   KC_2,   KC_3,   KC_4,
        ...
        _______,LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), LGUI(KC_B),     LGUI(KC_N), LGUI(KC_M), _______,    _______,    _______,    _______,KC_PGUP,_______,
...
//        _______,_______,_______,_______,_______,                _______,_______,                _______,KC_HOME,KC_PGDN,KC_END
    ...
    [_RAISE] = LAYOUT(
        KC_1,   KC_2,   KC_3,   KC_4,
        KC_TILD,KC_EXLM,    KC_AT,      KC_HASH,    KC_DLR,     KC_PERC,        KC_CIRC,    KC_AMPR,    KC_ASTR,    KC_LPRN,    KC_RPRN,    KC_UNDS,KC_PLUS,KC_TILD,KC_PIPE,
        ...
        _______,RSFT(KC_A), RSFT(KC_S), RSFT(KC_D), RSFT(KC_F), RSFT(KC_G),     RSFT(KC_H), RSFT(KC_J), RSFT(KC_K), RSFT(KC_L), _______,    _______,_______,
