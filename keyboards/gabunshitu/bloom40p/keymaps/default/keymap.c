...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        LT(_LOWER,  KC_LANG1),      KC_LALT,KC_LGUI,        KC_SPC, KC_RSFT,LT(_RAISE,  KC_LANG2)
    ),
    [_LOWER] = LAYOUT(
        KC_GRV,     KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_EQL, KC_DEL,
        _______, 	KC_F5,  KC_F6,  KC_F7,  KC_F8,  _______,KC_LEFT,KC_DOWN,KC_UP,  KC_RGHT,KC_RCBR,_______,
    ...
    [_RAISE] = LAYOUT(
        ...
        _______, 	_______,_______,_______,_______,_______,KC_HOME,KC_PGDN,KC_PGUP,KC_END, KC_RCBR,_______,
