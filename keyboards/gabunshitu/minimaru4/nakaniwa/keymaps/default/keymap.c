...
//        KC_9,  KC_0, KC_A, KC_B,
//        KC_C,  KC_D, KC_E,  KC_F,
//        KC_0, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,           KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   JP_MINS,JP_EQL, JP_YEN, KC_H,
//        KC_1, KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,           KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   JP_AT,  JP_LBRC,JP_RBRC,
//        KC_2,KC_A,   KC_S,   KC_D,   KC_F,   KC_G,           KC_H,   KC_J,   KC_K,   KC_L,   JP_SCLN,JP_QUOT,KC_G,
//        KC_3,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,           KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,JP_BSLS,KC_F,  KC_E,
//        KC_4,  KC_5,KC_6,KC_7,KC_8,                KC_9,KC_0,                 KC_A,KC_B,KC_C,KC_D
        ...
        KC_NO,  KC_LALT,KC_LGUI,KC_LALT,KL_EISU,                KL_KANA,KC_SPC,                 KL_KANA,KC_LEFT,KC_DOWN,KC_RIGHT,
    ...
    [_LOWER] = LAYOUT(
        ...
        _______,LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), LGUI(KC_B),     LGUI(KC_N), LGUI(KC_M), LGUI(KC_COMM),LGUI(KC_DOT), LGUI(KC_SLSH),      _______,    KC_PGUP,    _______,
        _______,_______,_______,_______,_______,                                _______,    KC_SPC,                                         _______,    KC_HOME,    KC_PGDN,    KC_END,
        _______,_______,_______,_______,
