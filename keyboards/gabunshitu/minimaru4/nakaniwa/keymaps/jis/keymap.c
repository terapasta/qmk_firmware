...
#define KL_EQL  LT(_LOWER, KC_PEQL)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        KC_NO,  KC_LALT,KC_LGUI,KC_LCTL,KL_EISU,                KL_KANA,KC_SPC,                 KL_LEFT,KC_LEFT,KC_DOWN,KC_RIGHT,
    ...
    [_LOWER] = LAYOUT(
        ...
        _______,_______,_______,_______,_______,                                KC_SPC,     _______,                                    _______,    KC_HOME,KC_PGDN, KC_END,
        _______,_______,_______,_______,
        _______,_______,_______,KC_SLSH,
        _______,_______,_______,JP_ASTR,
        _______,_______,_______, _______
    ),
    [_RAISE] = LAYOUT(
        _______,_______,_______,_______,
        ...
        _______,_______,_______,_______,
        _______,_______,_______,_______,
        KC_TILD,KC_EXLM,    KC_AT,      KC_HASH,    KC_DLR,     KC_PERC,        KC_CIRC,    KC_AMPR,    KC_ASTR,    KC_LPRN,    KC_RPRN,    JP_EQL, KC_TILD,KC_PIPE,RSFT(KC_BSPC),
