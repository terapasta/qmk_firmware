...
//    KC_LCTL, ADJUST,  KC_LALT, KC_LGUI, KL_EISU, KC_SPC, KC_SPC,  KL_KANA, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    KC_1,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,   KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_8,
    KC_2,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,   KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_3, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_7,
...
[_ADJUST] =  LAYOUT(
    ...
    _______, _______, BL_TOGG, BL_BRTG, _______, _______, _______, _______, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD
)
};
